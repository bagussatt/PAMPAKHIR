...
fun ShowIncomeScreen(
    ...
    incomeViewModel: IncomeViewModel,
        ...
        val incomeList by incomeViewModel.getAllData().collectAsState(initial = emptyList())
        ...
        Surface(
            ...
            Column(
                ...
                if (isTableVisible) {
                    IncomeTableScreen(incomeList = incomeList)
                }
            }
        }
    }
    ...
    @Composable
    fun IncomeTableScreen(incomeList: List<IncomeData>) {
        Column(
            modifier = Modifier
                .fillMaxSize()
                .padding(16.dp)
            ...
            LazyColumn(
                ...
                items(incomeList) { income ->
                    Row(
                        ...
                        Text(income.idIncome, modifier = Modifier.weight(1f))
                        Text(income.date, modifier = Modifier.weight(1f))
                        Text(income.uangmasuk.toString(), modifier = Modifier.weight(1f))
